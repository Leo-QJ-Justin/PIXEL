...
class Launcher:
    ...
    def launch_app(self, path: str) -> None:
        ...
        try:
            ...
            raise LaunchError(f"App not found: {path}")
        except Exception as e:
            raise LaunchError(f"Failed to launch {path}: {e}")
    ...
    def launch_url(self, url: str) -> None:
        ...
        try:
            ...
            raise LaunchError(f"Failed to open URL {url}: {e}")
    ...
    def launch_folder(self, path: str) -> None:
        ...
        try:
            ...
            raise LaunchError(f"Folder not found: {path}")
        except Exception as e:
            raise LaunchError(f"Failed to open folder {path}: {e}")
